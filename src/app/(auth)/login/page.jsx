    ...
    <div className="flex h-full w-full items-center justify-center">
      <div className="flex w-[30%] flex-col gap-4 p-4 text-black">
        ...
        <form className="flex flex-col gap-4" action={login}>
          <div className="0 relative w-full items-center rounded-md border border-gray-200 px-2 py-1 focus-within:ring-1 focus-within:ring-black">
            <input
              type="text"
          ...
          <div className="0 relative flex w-full items-center rounded-md border border-gray-200 px-2 py-1 focus-within:ring-1 focus-within:ring-black">
            <input
        ...
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 rounded-lg bg-black px-4 py-2 font-medium text-white">
